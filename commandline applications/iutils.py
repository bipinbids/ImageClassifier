...
def nn_setup(structure='vgg16',dropout=0.5, hidden_layer1 = 4096,lr = 0.001,device='gpu'):
...
def deep_learn(model, criterion, optimizer, epochs = 3, print_every=40, loader=0, device='gpu'):
    steps = 0
